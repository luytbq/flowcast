...
// csvEncodings là các bảng mã thử lần lượt khi không chỉ định, đúng thứ tự của
// bản tham chiếu. utf-8-sig đứng trước nên mọi file utf-8 hợp lệ đều được báo là
// utf-8-sig, kể cả khi không có BOM.
var csvEncodings = []string{"utf-8-sig", "utf-8", "cp1252"}

// encodingAliases chuẩn hóa tên bảng mã người dùng gõ vào --encoding về tên mà
// decode hiểu. Chỉ nhận bốn bảng mã: Python nhận hàng trăm, nhưng tái tạo codec
// của Python thì không đáng; tên lạ được xử lý như Python xử lý một tên nó không
// biết.
...
// decode giải mã bytes theo một bảng mã, như bytes.decode của Python với
// errors="strict". ok là false khi giải mã không được hoặc không biết bảng mã.
